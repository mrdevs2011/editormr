// Faza 2A-1: migrateProjectMeta v0/v1 → v2 sof testlari.
...
test('v0 (schemaVersion yo\'q) → v2: canvas=null, fit=contain', () => {
  const meta = {
...
test('v1 + eski string canvas → v2: canvas=null', () => {
  const meta = {
    schemaVersion: 1,
    canvas: '9:16',
    clips: [{ id: 'c1' }],
...
test('v2 allaqachon — o\'zgarmaydi', () => {
  const meta = {
    schemaVersion: 2,
