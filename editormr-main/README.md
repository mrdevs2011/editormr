...
├── assets/                   # logo.png, apple-touch-icon.png, favicon-32.png
├── README.md                # Shu fayl
│
...
│   └── responsive.css         # Touch/tablet/mobil/landscape moslashuvi
│
└── js/                       # Mantiq — har bir fayl bitta vazifaga javobgar
    ├── state.js                # Global state obyekti + yordamchi getter'lar
...
- 🖱️ Erkin drag & drop (vertikal va gorizontal)
